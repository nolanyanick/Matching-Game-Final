...
{
    public partial class Game8X8 : Form
    {
        public Game8X8()
        {
            InitializeComponent();
        ...
        private void ValidateWin()
        {
            ...
            //
            //allows the last two icons to chanage color before the message appears
            //
            msgTimer.Start();
            firstIcon.ForeColor = Theme.elementForeColor;
            secondIcon.ForeColor = Theme.elementForeColor;
            ...
            //
            //closes Game8X8 form and opens up the MenuScreen form
            //
            Close();         
        }

        /// <summary>
        /// game timer for a 8X8 game grid
        /// </summary>
        ...
        /// <summary>
        /// opens the MenuScreen form when closing the Game8X8 form
        /// </summary>
        private void Game8X8_FormClosing(object sender, FormClosingEventArgs e)
        {
            FormProvider.MenuScreen.Show();
        }
    }
