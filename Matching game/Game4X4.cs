...
namespace Matching_game
{
    ...
    {        
        ...
        //
        //Label variables that will track which icons have been selected
        //
        ...
        private void AssignRanodmIconToLabel()
        {
            foreach (Control icon in tblGame.Controls)
            {
                ...
                if (iconLabel != null)
                {
                    ...
                    iconLabel.Text = icons[randomNumber]; //adds text to labels taken from the "icons" list
        ...
        {           
            ...
            //
            //allows the last two icons to change color before the message appears
            //
            msgTimer.Start();
            firstIcon.ForeColor = Theme.elementForeColor;
            secondIcon.ForeColor = Theme.elementForeColor;
            ...
            //
            //closes Game4X4 form and opens up the MenuScreen form
            //
            Close();
        ...
        /// <summary>
        /// game timer for a 4X4 game grid
        /// </summary>
        ...
        /// <summary>
        /// opens the MenuScreen form when closing the Game4X4 form
        /// </summary>
